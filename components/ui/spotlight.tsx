...
export function Spotlight({
  ...
  return (
    <motion.div
      ref={containerRef}
      className={cn(
        'pointer-events-none absolute rounded-full bg-[radial-gradient(circle,var(--tw-gradient-from),transparent_80%)] blur-xl transition-opacity duration-200',
        'from-zinc-50 dark:from-zinc-400',
